...
class UserByComprensionAdapter(context: Context?, idSala: Int) : ArrayAdapter<Usuario?>(
    context!!, 0
) {

    companion object {
        private const val TAG = "UserByComprensionAdapter"
    }
    ...
    fun setListUsuarios(usuariosList: MutableList<Usuario?>){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (null == view) {
            ...
            view = layoutInflater.inflate(R.layout.items_user_comprension, parent, false)
        }
        ...
        val idSala = view!!.findViewById<TextView>(R.id.item_id_user_comprension)
        //idSala.text = sala!!.id

        val usernameItem = view.findViewById<TextView>(R.id.item_user_user_comprension)
...
/*        val removeVotanteButton = view.findViewById<Button>(R.id.item_remove_user_comprension)
